...
close all 
clear all 
fc1=50;('Enter the freq of 1st Sine Wave carrier:');
fc2=25;('Enter the freq of 2nd Sine Wave carrier:');
fp=5;('Enter the freq of Periodic Binary pulse (Message):');
amp=3;('Enter the amplitude (For Both Carrier & Binary Pulse Message):');
amp=amp/2;
